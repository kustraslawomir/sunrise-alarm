...
import 'package:sunrise.alarm/ui/pages/homepage/state/home_page_controller.dart';
import 'package:sunrise.alarm/ui/pages/homepage/widget/app_bar_title.dart';
import 'package:sunrise.alarm/ui/pages/homepage/widget/sunrise_time_description.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: const Padding(
            ...
            child: Center(
            child: Column(
          children: [SunriseTimeDescription()],
        ))));
  }
}
